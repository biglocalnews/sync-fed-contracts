...
all_depts = pandas.concat([df["contracting_agency_department"],df["funding_agency_department"]]).dropna().unique().tolist()
...
if selected_departments:
    df = df[(df["contracting_agency_department"].isin(selected_departments))|(df["funding_agency_department"].isin(selected_departments))]
